...
exports.seed = async function(knex) {
  ...
  await knex('notifications').insert([
    {type: 'entry-created', payload: {entry: '001', step: 'New', folder: 'Reports', user: 'Henry McCoy'},
      user_id: 'beast~mailinator.com@marvel-x-men', read: true, project_id: 'default', action_url: 'https://notifir.github.io/widget'},
    {type: 'entry-created', payload: {entry: '001', step: 'New', folder: 'Reports', user: 'Henry McCoy'},
      user_id: 'angel~mailinator.com@marvel-x-men', read: false, project_id: 'default', action_url: 'https://notifir.github.io/widget'},
    ...
    {type: 'entry-moved', payload: {entry: '002', from_step: 'New', to_step: 'Open', folder: 'Reports', user: 'Angel Avening'},
      user_id: 'angel~mailinator.com@marvel-x-men', read: false, project_id: 'default', action_url: 'https://notifir.github.io/widget'},
    {type: 'entry-moved', payload: {entry: '002', from_step: 'New', to_step: 'Open', folder: 'Reports', user: 'Angel Avening'},
      user_id: 'beast~mailinator.com@marvel-x-men', read: false, project_id: 'default', action_url: 'https://notifir.github.io/widget'},
